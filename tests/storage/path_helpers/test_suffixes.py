...
from mountainash_transport.storage.path_helpers.suffixes import infer_pipeline, SUFFIX_TRANSFORMS
...
def test_infer_pipeline_exported_from_path_helpers():
    from mountainash_transport.storage.path_helpers import infer_pipeline as from_subpkg
    from mountainash_transport.storage.path_helpers.suffixes import infer_pipeline as from_mod
...
def test_suffix_transforms_exported_from_path_helpers():
    from mountainash_transport.storage.path_helpers import SUFFIX_TRANSFORMS as from_subpkg
    from mountainash_transport.storage.path_helpers.suffixes import SUFFIX_TRANSFORMS as from_mod
    assert from_subpkg is from_mod
