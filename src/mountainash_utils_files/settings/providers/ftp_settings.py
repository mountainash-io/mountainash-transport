...
(:func:`mountainash_utils_files.settings.adapters.ftp.build_handler_kwargs`)
...
FTP_SPEC = StorageDescriptor(
    ...
    handler_module="mountainash_utils_files.storage_backends.ftp",
...
def _adapter(profile: "FTPSettings") -> dict[str, t.Any]:
