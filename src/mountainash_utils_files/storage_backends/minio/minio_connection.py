"""MinIOConnectionMixin — boto3 connection management for MinIO."""
...
class MinIOConnectionMixin:
    """Connection mixin for MinIO using boto3.
    ...
    def connect(self) -> None:
        """Create and cache a boto3 S3 client pointed at a MinIO endpoint.
        ...
        try:
            ...
            raise StorageConnectionError(
                f"Failed to create MinIO client: {exc}"
            ) from exc
